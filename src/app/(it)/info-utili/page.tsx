...
export const metadata: Metadata = {
  title: "Info Utili",
  description:
    "Dove mangiare e dormire a Francavilla di Sicilia durante la Sacra Rappresentazione. Ristoranti, bar e strutture ricettive consigliate.",
};
...
const strutture = [
  {
    name: "Casa Catena",
    address: "Piazza Garibaldi, 22, 98034 Francavilla di Sicilia ME",
    link: "https://www.booking.com/hotel/it/casa-catena.it.html",
    linkLabel: "Booking.com",
  },
  {
    name: "Sweet Home",
    address: "Via Ariosto, 1, 98034 Francavilla di Sicilia ME",
    link: "https://www.booking.com/hotel/it/sweet-home-francavilla-di-sicilia.it.html",
    linkLabel: "Booking.com",
  },
  {
    name: 'Casa Vacanza "Al n° 5"',
    address: "Via Cesare Battisti, 60, 98034 Francavilla di Sicilia ME",
    link: "https://www.booking.com/hotel/it/al-numero-5-francavilla-di-sicilia.it.html",
    linkLabel: "Booking.com",
  },
];
    ...
    <div style={{ padding: "20px 24px", background: "white", borderRadius: 10, boxShadow: "var(--shadow-sm)", border: "1px solid var(--color-border)" }}>
      ...
      {(maps || link) && (
        <a
          ...
          style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: "0.78rem", fontWeight: 600, color: "var(--color-primary)", letterSpacing: "0.02em" }}
        >
          {maps ? "Visualizza su Google Maps" : linkLabel ?? "Visita il sito"}
      ...
      <div className="page-hero">
        <div className="container">
          <div className="page-hero-inner">
            ...
            <h1>Info Utili</h1>
            <p>Tutto quello che serve sapere per vivere al meglio la Sacra Rappresentazione a Francavilla di Sicilia.</p>
          </div>
        </div>
      </div>
      ...
      <section style={{ padding: "var(--section-py) 0", background: "var(--color-bg)" }}>
        <div className="container">
          ...
          <div style={{ marginBottom: 72 }}>
            ...
            <h2 style={{ marginBottom: 8 }}>Location principale</h2>
            <div className="section-divider" />
            <p style={{ marginBottom: 32, maxWidth: 600, color: "var(--color-text-muted)" }}>
              La Sacra Rappresentazione si svolge nel borgo antico di Francavilla di Sicilia, lungo le vie storiche del centro abitato.
            </p>
            <div className="map-wrapper">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1574.1746744425022!2d15.1367917386376!3d37.898896309510484!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13141bed56d3417d%3A0xa2015d743755e74f!2sVia%20Filippo%20Romano%2C%2098034%20Francavilla%20di%20Sicilia%20ME!5e0!3m2!1sit!2sit!4v1743381260508!5m2!1sit!2sit"
                title="Location principale Francavilla di Sicilia"
                allowFullScreen
                loading="lazy"
          ...
          <div style={{ display: "grid", gap: 64, alignItems: "start" }} className="info-grid">
            {/* Dove mangiare */}
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
                <div style={{ width: 36, height: 36, borderRadius: 8, background: "rgba(24,139,135,0.1)", color: "var(--color-primary)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <Utensils size={18} />
                </div>
                <span className="section-tag" style={{ margin: 0 }}>Dove mangiare</span>
              </div>
              <h2 style={{ marginBottom: 8 }}>Ristoranti e locali</h2>
              <div className="section-divider" />

              <h4 style={{ marginBottom: 16, color: "var(--color-text-muted)", fontSize: "0.8rem", fontFamily: "var(--font-body)", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase" }}>
                Bar e Tavola Calda
              </h4>
              <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 32 }}>
                {bars.map((b) => <PlaceCard key={b.name} {...b} />)}
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {ristoranti.map((r) => <PlaceCard key={r.name} {...r} />)}
              </div>
            </div>
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
                ...
                <span className="section-tag" style={{ margin: 0 }}>Dove dormire</span>
              </div>
              <h2 style={{ marginBottom: 8 }}>Strutture ricettive</h2>
              <div className="section-divider" />
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {strutture.map((s) => <PlaceCard key={s.name} {...s} />)}
              </div>
            </div>
          </div>
        </div>
