        ...
        <div className="container">
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: 68 }}>
            ...
            <div className="nav-desktop">
              ...
              <Link href="/en" style={{ display: "flex", alignItems: "center", gap: 6, padding: "7px 14px", marginLeft: 8, border: "1.5px solid var(--color-primary)", borderRadius: 4, fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase" as const, color: "var(--color-primary)" }}>
                <Globe size={13} />EN
              </Link>
            </div>
