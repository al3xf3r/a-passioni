        ...
        <div className="container">
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: 68 }}>
            ...
            <div className="nav-desktop">
              ...
              <Link href="/" style={{ display: "flex", alignItems: "center", gap: 6, padding: "7px 14px", marginLeft: 8, border: `1.5px solid ${isTransparent ? "rgba(255,255,255,0.5)" : "var(--color-primary)"}`, borderRadius: 4, fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase" as const, color: isTransparent ? "rgba(255,255,255,0.94)" : "var(--color-primary)", transition: "all 0.3s" }}>
                <Globe size={13} />IT
              </Link>
            </div>
      ...
      <div className={`nav-mobile-overlay ${mobileOpen ? "open" : ""}`}>
        <div className="nav-mobile-inner">
          ...
          <div style={{ padding: "24px 20px" }}>
            <Link href="/" onClick={close} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "10px 20px", border: "1.5px solid var(--color-primary)", borderRadius: 4, fontSize: "0.85rem", fontWeight: 600, textTransform: "uppercase" as const, color: "var(--color-primary)" }}>
