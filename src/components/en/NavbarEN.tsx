  ...
  return (
    <>
      <nav style={{
        ...
        background: "white",
        boxShadow: scrolled ? "0 2px 12px rgba(0,0,0,0.10)" : "0 1px 0 rgba(0,0,0,0.07)",
      ...
      <style>{`
        ...
        .nav-hamburger { display: none; background: none; border: 1.5px solid #d0ccc6; border-radius: 6px; cursor: pointer; color: #1a1a1a; padding: 6px 8px; align-items: center; justify-content: center; }
